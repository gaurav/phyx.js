...
- PR #166: Replaced esdoc, which has had no release since 2018, with jsdoc and clean-jsdoc-theme. The documentation at [https://www.phyloref.org/phyx.js/](https://www.phyloref.org/phyx.js/) is now served from clean URLs, so links into the old pages need updating, and `PhylogenyWrapper` is published for the first time — esdoc and jsdoc alike had been skipping it as undocumented.
- PR #179: Stopped committing generated documentation. The JSON-LD contexts and JSON Schemas moved from `docs/context/` to `context/` at the repository root, changing their path within the published NPM package; they continue to be served from [https://www.phyloref.org/phyx.js/context/](https://www.phyloref.org/phyx.js/context/).

## [1.2.1](https://github.com/phyloref/phyx.js/compare/v1.2.0...v1.2.1) - 2025-07-28

- PR #152: Upraded packages using `npm upgrade`.

## [1.2.0](https://github.com/phyloref/phyx.js/compare/v1.1.1...v1.2.0) - 2025-03-10
...
## [1.1.1](https://github.com/phyloref/phyx.js/compare/v1.1.0...v1.1.1) - 2023-08-01
...
## [1.1.0](https://github.com/phyloref/phyx.js/compare/v1.0.1...v1.1.0) - 2023-05-11
...
## [1.0.1](https://github.com/phyloref/phyx.js/compare/v1.0.0...v1.0.1) - 2021-10-15
...
## [1.0.0](https://github.com/phyloref/phyx.js/compare/v0.2.1...v1.0.0) - 2021-03-16
...
## [0.2.1](https://github.com/phyloref/phyx.js/compare/v0.2.0...v0.2.1) - 2019-08-15
...
## [0.2.0](https://github.com/phyloref/phyx.js/compare/v0.1.2...v0.2.0) - 2019-07-18
...
## [0.1.2](https://github.com/phyloref/phyx.js/compare/v0.1.1...v0.1.2) - 2019-02-08

### Added

- Moved Phyx context file for JSON-LD into this repository from the Curation Tool and changed URI to point to it.

## [0.1.1](https://github.com/phyloref/phyx.js/compare/v0.1.0...v0.1.1) - 2019-02-06

### Added

- A replacement for the Phylotree.js Newick parser.

## [0.1.0](https://github.com/phyloref/phyx.js/releases/tag/v0.1.0) - 2019-01-27

### Added

- Transfered initial code from the [Phyloreference Curation Tool](http://github.com/phyloref/curation-tool). The initial release of this package was based on [commit 14d2c3d5d1](https://github.com/phyloref/curation-tool/commit/14d2c3d5d12ee4e925e29961bd46587aabfb8cd4) in that repository.

### Changed

- Replaced references to the [phylotree](https://www.npmjs.com/package/phylotree) library with the [newick-js](https://www.npmjs.com/package/newick-js) library.
